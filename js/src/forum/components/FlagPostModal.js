...
export default class FlagPostModal extends Modal {
  ...
  title() {
    return app.translator.trans('duroom-flags.forum.flag_post.title');
  }
      ...
      return (
        <div className="Modal-body">
          <div className="Form Form--centered">
            <p className="helpText">{app.translator.trans('duroom-flags.forum.flag_post.confirmation_message')}</p>
            <div className="Form-group">
              <Button className="Button Button--primary Button--block" onclick={this.hide.bind(this)}>
                {app.translator.trans('duroom-flags.forum.flag_post.dismiss_button')}
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="Form Form--centered">
          ...
          <div className="Form-group">
            <Button className="Button Button--primary Button--block" type="submit" loading={this.loading} disabled={!this.reason()}>
              {app.translator.trans('duroom-flags.forum.flag_post.submit_button')}
            </Button>
          </div>
        </div>
      </div>
  ...
  flagReasons() {
    ...
    items.add(
      ...
      <label className="checkbox">
        ...
        <strong>{app.translator.trans('duroom-flags.forum.flag_post.reason_off_topic_label')}</strong>
        {app.translator.trans('duroom-flags.forum.flag_post.reason_off_topic_text')}
        {this.reason() === 'off_topic' ? (
          <textarea
            className="FormControl"
            placeholder={app.translator.trans('duroom-flags.forum.flag_post.reason_details_placeholder')}
    ...
    items.add(
      ...
      <label className="checkbox">
        ...
        />
        <strong>{app.translator.trans('duroom-flags.forum.flag_post.reason_inappropriate_label')}</strong>
        {app.translator.trans('duroom-flags.forum.flag_post.reason_inappropriate_text', {
    ...
    items.add(
      ...
      <label className="checkbox">
        ...
        <strong>{app.translator.trans('duroom-flags.forum.flag_post.reason_spam_label')}</strong>
        {app.translator.trans('duroom-flags.forum.flag_post.reason_spam_text')}
        {this.reason() === 'spam' ? (
          <textarea
            className="FormControl"
            placeholder={app.translator.trans('duroom-flags.forum.flag_post.reason_details_placeholder')}
    ...
    items.add(
      ...
      <label className="checkbox">
        ...
        <strong>{app.translator.trans('duroom-flags.forum.flag_post.reason_other_label')}</strong>
        {this.reason() === 'other' ? (
