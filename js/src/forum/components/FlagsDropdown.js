...
import NotificationsDropdown from 'duroom/components/NotificationsDropdown';

import FlagList from './FlagList';

export default class FlagsDropdown extends NotificationsDropdown {
  static initAttrs(attrs) {
    attrs.label = attrs.label || app.translator.trans('duroom-flags.forum.flagged_posts.tooltip');
